...
#    tasks = []
    ...
    tasks.append(task)
    r = requests.get('http://root:9605/todo/api/v1.0/tasks')
# POST verb on the api
    s = requests.post('http://intermediate:9604/todo/api/v1.0/tasks',json.dumps(task),headers={"Content-type":"application/json; charset=utf8"})
